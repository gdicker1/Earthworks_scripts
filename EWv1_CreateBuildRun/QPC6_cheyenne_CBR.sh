...
for NTASKS in ${NTASKSS[@]:-"-1"}; do
  ...
  case $RES in
    120)
      BLCK_PRE="/glade/u/home/gdicker/mpas_resources/meshes/x1.40962_mesh/x1.40962.graph.info.part."
      ;;
    60)
      BLCK_PRE="/glade/u/home/gdicker/mpas_resources/meshes/x1.163842_mesh/x1.163842.graph.info.part."
      ;;
    30)
      BLCK_PRE="/glade/u/home/gdicker/mpas_resources/meshes/x1.655362_mesh/x1.655362.graph.info.part."
      ;;
    *)
  ...
  DT="$(( 450 / (120 / $RES) )).0D0"  # DT is set relative to the 120km resolution
  # End Set loop vars #########################################################
  ...
  if [ "$DO_CREATE" = true ]; then
    ...
    ###########################################################################
    vexec "cd $CASEROOT"
    vexec "./xmlchange CAM_CONFIG_OPTS='-analytic_ic -nlev 32'"
...
&camexp
 ...
 ncdata= '/glade/p/cesmdata/cseg/inputdata/atm/cam/inic/mpas/mpasa120_L32_notopo_coords_c201216.nc'
 mpas_dt = $DT
/
